...
public class BusinessYolcu extends Yolcu {
	...
	static Map<String,Integer> biletlerBusiness = new HashMap<>();  //firma adı ve bilet fiyatı tutmalı
	...
	public void biletAl(FirmaAdi firmaAdi) {
		if(isVIP == true) {
			...
			biletlerBusiness.put(firmaAdi.name(), biletFiyati);
			System.out.println("BUSINESS Bilet alınmıştır.");
		}
